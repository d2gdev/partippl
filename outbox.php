            ...
            <div class="mail-container">
                <div class="mail-content">
                    ...
                    <div class="mail-right">
                        ...
                        <?php
                            $data = $s_que->select_chat_message_for_outbox();
                            if ($data !=  false) {
                        ?>
                            <?php foreach($data as $result){ ?>
                                <div class="mail-right-content">
                                    <a href="chat_details2.php?chat_id=<?php echo $result['c_to'] ?>" class="mail-right-content-left">
                                        <p><?php echo $result['c_to'] ?></p>
                                    </a>
            ...
            <div class="mail-container">
                <div class="mail-content">
                    ...
                    <div class="mail-right">
                        ...
                        <?php
                            $data = $s_que->select_chat_message_2_for_job_seeker();
                        ?>
