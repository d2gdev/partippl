...
<head>
    ...
    <title>Party</title>
    <link rel="stylesheet" href="css/home/style-2.css">
            ...
            <div class="hero-left">
                <div class="hero-left-header">
                    <div class="hero-left-header-left">
                        <img src="img/ppl-Logo.png" width="100%" height="100%" alt="">
                    </div>
                ...
                <img src="img/glass.png" width="100%" height="100%" alt="" class="img-2">

                <div class="hero-left-content">
                    <b>PARTY PEOPLE</b>

                    <img src="img/glass.png" width="100%" height="100%" alt="" class="img-3">
                    <img src="img/glass.png" width="100%" height="100%" alt="" class="img-4">
                        ...
                        <?php foreach($data as $result){ ?>
                            <div class="hero-right-block">
                                <div class="hero-right-left">
                                    <img src="job_seeker_img/<?php echo $result['j_img'] ?>" width="90%" height="80%" alt="">
                                </div>
    ...
    <div class="footer">
        <div class="footer-container">
            <div class="footer-left">
                <div class="logo"><img src="img/ppl-Logo.png" width="100%" height="100%" alt=""></div>
